package com.learn.lilintong.apitoken.controller;

import com.learn.lilintong.apitoken.annotation.AuthToken;
import com.learn.lilintong.apitoken.annotation.NotRepeatSubmit;
import com.learn.lilintong.apitoken.model.*;
import com.learn.lilintong.apitoken.service.ITokenService;
import com.learn.lilintong.apitoken.util.MD5Util;
...
public class TokenController {
    ...
    @PostMapping("/token")
    public TokenResVo getToken(@Valid @RequestBody TokenReqVo tokenReqVo) {
        return tokenService.getToken(tokenReqVo);
    }

    @AuthToken
    @PostMapping("/refreshtoken")
    public TokenResVo refreshToken(@Valid @RequestBody TokenRefreshReqVo tokenRefreshReqVo) {
        return tokenService.refreshToken(tokenRefreshReqVo);
    }
